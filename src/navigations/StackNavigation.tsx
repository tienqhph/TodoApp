...
const StackNavigation = () => {
  ...
  const HomeStack = (
    <Stack.Navigator screenOptions={{headerShown:false}} initialRouteName={NAME_NAVIGATION.HOME}>
      ...
      <Stack.Screen component={TaskDetailScreen} name={NAME_NAVIGATION.TASKDETAIL} />
